#ifndef TIMESTAMPED_ONOFF_APPLICATION_H
#define TIMESTAMPED_ONOFF_APPLICATION_H
 ...
 */
class TimeStampedOnOffApplication : public Application
{
  public:
    /**
    ...
    TimeStampedOnOffApplication();

    ~TimeStampedOnOffApplication() override;
